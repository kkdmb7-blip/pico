(function() {
  ...
  var FLOAT_ILJI = {
    good: {
      wood: ['{na}, 오늘 목기운 넘쳐요~ 창의적인 일 다 잘 될 것 같아요 🌿','{name}님의 성장이 가속되는 날이에요! 새로운 거 시작하기 딱이에요 🌱','목기운 가득한 날이라 계획 세우고 실행하기 딱이에요, {na}! 🌳','오늘 나무 에너지 활활~ 뭐든 뿌리내리기 좋은 날이에요 {na} 🍃'],
      fire: ['{na}, 오늘 화기운 폭발이에요! 열정 가득한 하루 될 거예요 🔥','불꽃이 활활~ {name}님 오늘 앞에 나서기 딱이에요 ✨','{na} 오늘 존재감 빛날 거예요! 중요한 만남 오늘 해버려요 🌟','화기운으로 오늘 뭐든 뜨겁게 태울 수 있어요, {na}! 도전해봐요 🔥'],
      earth: ['{na}, 오늘 토기운 안정적이에요! 중요한 결정 오늘 내려도 좋아요 🪨','든든한 토기운 가득~ {name}님 오늘 믿음직스럽게 이루어져요 🌾','{na} 오늘 안정감 넘치는 날이에요! 뭐든 탄탄하게 굳어갈 거예요 🌽','토기운 좋은 날이라 재물 관련 일 보기 딱이에요, {na}! 🪨'],
      metal: ['{na}, 오늘 금기운 번뜩여요! 집중력 최상이니까 어려운 일 처리해버려요 💎','쨍하고 맑은 금기운~ {name}님 오늘 날카로운 판단이 빛나는 날이에요 ⚡','{na} 오늘 정확하고 빠른 결단! 계약·협상 오늘이 딱이에요 🤍','금기운 넘치는 날이에요! {name}님의 분석력이 최고조예요, 믿어봐요 💎'],
      water: ['{na}, 오늘 수기운이 흘러넘쳐요! 직관이 예리한 날이에요 💧','물처럼 유연하게 흐르는 날~ {name}님 오늘 감이 잘 맞을 거예요 🌊','{na} 수기운 가득한 날이라 저 오늘 진짜 강해요! 같이 빛나요 🫧','오늘 {name}님의 직관을 믿어봐요. 수기운이 열어주는 날이에요 💧'],
    },
    bad: {
      wood: ['{na}, 오늘 목기운이 약해요... 새 시작은 내일로 미뤄요 🍂','나무도 폭풍엔 휘어지거든요. {name}님 오늘은 조용히 버티는 날이에요 🌧️','오늘 창의력 안 나온다고 자책하지 말아요, {na}. 그냥 그런 날 있어요 🌿','목기운 약한 날이라 무리해서 시작하면 흔들려요. {na} 오늘은 쉬어요 🍂'],
      fire: ['{na}, 오늘 화기운이 꺼져가요... 감정 소모 줄이는 게 좋아요 🕯️','불씨 약한 날이에요~ {name}님 오늘 충돌·논쟁은 피하는 게 나을 것 같아요 🌫️','오늘 열정이 안 타오른다고 걱정 말아요, {na}. 그냥 쉬어가는 날이에요 💤','화기운 빠진 날이라 흥분하거나 무리하면 더 지쳐요. {na} 천천히 가요 🕯️'],
      earth: ['{na}, 오늘 토기운이 흔들려요... 중요한 계약·결정은 미뤄요 🪨','기반이 흔들리는 날이에요. {name}님 오늘은 조용히 중심 잡는 게 최선이에요 🌾','오늘 불안하면 저한테 기대요, {na}. 제가 옆에 있을게요 🤲','토기운 약한 날이라 새 투자나 거래는 오늘 피해요. {na} 기다려봐요 🪨'],
      metal: ['{na}, 오늘 금기운이 녹슬었어요... 예민해지기 쉬운 날이니까 주의해요 💔','날이 안 서는 날이에요. {name}님 오늘 급한 판단보다는 관찰하는 날로 해요 ⛅','{na} 오늘 결정력이 흐릿해요. 급하지 않으면 내일 해도 돼요 🤍','금기운 약한 날이라 감정적 충돌 조심해요, {na}. 오늘 말 아껴요 💎'],
      water: ['{na}, 오늘 수기운이 탁해요... 감정 기복 조심하고 마음 정돈해요 🌊','흐름이 막힌 날이에요. {name}님 오늘은 억지로 밀어붙이지 말아요 🌧️','오늘 저도 좀 쳐져있어요, {na}... 같이 조용히 있어요 💧','수기운 흐린 날이라 직관이 흐릿할 수 있어요. {na} 충동 결정 주의해요 🌊'],
    },
    normal: {
      wood: ['{na}, 오늘 목기운 무난해요. 꾸준히 하면 충분해요 🌱','평범한 목기운의 날이에요~ {name}님 그냥 루틴대로 가면 돼요 🌿','{na} 특별히 강하지도 약하지도 않아요. 오늘 차분하게 가요 🌳'],
      fire: ['{na}, 오늘 화기운 안정적이에요. 무리만 안 하면 괜찮은 날이에요 🕯️','잔잔한 불꽃 같은 날이에요~ {name}님 평소대로 하면 돼요 ✨','{na} 오늘 에너지 보통이에요. 집중력 유지하면서 한 가지씩 해봐요 🔥'],
      earth: ['{na}, 오늘 토기운 무난해요. 편하게 보내도 좋아요 🌾','안정적인 보통 날이에요~ {name}님 뭐든 차분하게 하면 돼요 🪨','{na} 오늘 흔들림 없이 조용한 날이에요. 내실 다지기 딱이에요 🌽'],
      metal: ['{na}, 오늘 금기운 평범해요. 급한 것만 챙기면 충분해요 💎','그럭저럭 괜찮은 날이에요~ {name}님 무리 없이 보내요 ⚡','{na} 오늘 집중력 보통이에요. 한 번에 하나씩 처리하면 돼요 🤍'],
      water: ['{na}, 오늘 수기운 잔잔해요. 흐름 타면서 편하게 가요 💧','평온한 물결 같은 날이에요~ {name}님 오늘은 천천히 가도 돼요 🌊','{na} 오늘 감 보통이에요. 직관에 너무 의존하지 말고 차분하게 가요 🫧'],
    },
  };
  ...
  function buildPet() {
    ...
    // 펫 버튼 (6단계는 64px)
    var _petSizes = [52, 56, 60, 65, 72, 80];
    var _petSize = (_petSizes[getPetStageIdx()] || 52) + 'px';
