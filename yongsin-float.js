(function() {
  ...
  var FLOAT_ILJI = {
    good: {
      wood: ['{na}, 목기운 넘쳐요~ 🌿','{name}님 성장하는 날! 🌱','계획 실행하기 딱! 🌳','뭐든 잘 될 거예요 🍃','새로 시작하기 좋아요 🌿'],
      fire: ['{na}, 화기운 폭발! 🔥','열정 가득한 하루예요 ✨','{name}님 오늘 빛나요 🌟','도전해봐요~ 🔥','앞에 나서기 딱! ✨'],
      earth: ['{na}, 토기운 안정적~ 🪨','중요한 결정 해도 좋아요 🌾','{name}님 오늘 든든해요 🌽','탄탄한 하루예요 🪨','재물운 좋아요 💰'],
      metal: ['{na}, 금기운 번뜩여요 💎','집중력 최상이에요 ⚡','{name}님 판단력 👍 🤍','계약·협상 딱! 💎','분석력 최고조예요 ⚡'],
      water: ['{na}, 수기운 흘러넘쳐요 💧','직관이 예리한 날 🌊','{name}님 감 좋아요 🫧','유연하게 흐르는 날~ 💧','같이 빛나요! 🌊'],
    },
    bad: {
      wood: ['{na}, 목기운 약해요... 🍂','새 시작은 내일로 🌧️','자책하지 말아요 🌿','오늘은 쉬어요~ 🍂','{name}님 조용히 🌧️'],
      fire: ['{na}, 화기운 꺼져가요 🕯️','감정 소모 줄여요 🌫️','천천히 가요~ 💤','{name}님 쉬어가요 🕯️','논쟁은 피해요 🌫️'],
      earth: ['{na}, 토기운 흔들려요 🪨','계약은 미뤄요 🌾','제가 옆에 있을게요 🤲','중심 잡는 날~ 🪨','{name}님 기다려요 🌾'],
      metal: ['{na}, 금기운 녹슬었어요 💔','예민해지기 쉬워요 ⛅','내일 해도 돼요 🤍','{name}님 말 아껴요 💎','조심조심~ ⛅'],
      water: ['{na}, 수기운 탁해요 🌊','감정 기복 조심~ 🌧️','저도 쳐져있어요 💧','{name}님 조용히 🌊','충동 결정 주의! 💧'],
    },
    normal: {
      wood: ['{na}, 목기운 무난해요 🌱','꾸준히 가요~ 🌿','루틴대로 🌳'],
      fire: ['{na}, 화기운 안정적 🕯️','평소대로 하면 돼요 ✨','한 가지씩~ 🔥'],
      earth: ['{na}, 토기운 무난해요 🌾','편하게 보내요~ 🪨','내실 다지기 좋아요 🌽'],
      metal: ['{na}, 금기운 평범해요 💎','무리 없이~ ⚡','하나씩 처리해요 🤍'],
      water: ['{na}, 수기운 잔잔해요 💧','천천히 가요~ 🌊','차분하게 🫧'],
    },
  };
